[![🤖CI run Regression in QA🧪](https://github.com/upex-galaxy/L2-cypex-trello/actions/workflows/CI-regressionQA.yml/badge.svg)](https://github.com/upex-galaxy/L2-cypex-trello/actions/workflows/CI-regressionQA.yml)
