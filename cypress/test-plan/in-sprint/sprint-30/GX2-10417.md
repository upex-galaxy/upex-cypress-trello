## 🎄Trello (API) | Stickers | API Endpoint: Add, Update, Get, Delete a Sticker on a Card
US Link: https://upexgalaxy30.atlassian.net/browse/GX2-10417
